...
- `orrery run <tool> [--flag val ...] [--golden]` — run with plain flags; prints the tool's envelope +
  the I-12 `declared_blake2b`/`artifact_blake2b`; exit mirrors the tool (0 pass · 1 gate-fired · 2 error).
